...
endloop:
    ...
    //int x = 1; // error: has initializer error: cannot jump from this goto statement to its label
    //Object obj2; // error: non-trivial dtor  note: jump bypasses variable with a non-trivial destructor
label2:
